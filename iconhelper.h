...
//                         const QString &borderColor = "#2FC5A2",
//                         const QString &normalBgColor = "#292F38",
//                         const QString &darkBgColor = "#f0f0f0",
//                         const QString &normalTextColor = "#000000",
//                         const QString &darkTextColor = "#000000");
...
//                  const QString &borderColor = "#2FC5A2",
//                  const QString &normalBgColor = "#f0f0f0",
//                  const QString &darkBgColor = "#f0f0f0",
//                  const QString &normalTextColor = "#000000",
//                  const QString &darkTextColor = "#000000");
...
//                  const QString &darkBgColor = "#2FC5A2",
//                  const QString &normalTextColor = "#f0f0f0",
//                  const QString &darkTextColor = "#000000");
//    //指定导航面板样式,不带图标
    static void setStyle(QWidget *widget, const QString &type = "left", int borderWidth = 3,
                         ...
                         const QString &darkTextColor = "black");
    ...
    void setStyle(QWidget *widget, QList<QToolButton *> btns, QList<int> pixChar,
                      ...
                      const QString &type = "left", int borderWidth = 3,
                      const QString &borderColor = "#029FEA",
                      const QString &normalBgColor = "white",// background
                      const QString &darkBgColor = "#cddaed",//hover、selected
                      const QString &normalTextColor = "#54626F",
                      const QString &darkTextColor = "black");

    //指定导航面板样式,带图标和效果切换(重写)
    void setReStyle(QWidget *widget, QList<QToolButton *> btns, QList<int> pixChar,
                  quint32 iconSize = 9, quint32 iconWidth = 10, quint32 iconHeight = 10,
                  const QString &type = "left", int borderWidth = 1,
                  const QString &borderColor = "#C5D0DC",
                  const QString &normalBgColor = "white",// background
                  const QString &darkBgColor = "",//hover、selected
                  const QString &normalTextColor = "black",
                  const QString &darkTextColor = "black");
